...
def generate_comprehensive_pdf(stats, change_map_img, orig1_pil, orig2_pil, mask1_pil, mask2_pil):
    ...
    for i in range(1, 4):
        ...
        pdf.cell(0, 10, 'Page ' + str(i) + '/3 | Urban Change Detection Report | Generated by AI', ln=True, align='C')
...
with col1:
    ...
    st.markdown('<div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.25rem;">'
